...
//Daftar
	...
	$bodi="Kode Verifikasi Anda Adalah : <b>$kodeverify</b>.";
...
<!-------------------------------------------------------------------------------- Start Verifikasi ------------------------------------------------------------------------------------------>						
							...
							<div class="header">
                                <h4 class="title">Verifikasi E-Mail</h4>
							...
							<div class="content">								
								<ul>
									...
									<li>Kode Verifikasi Dikirim Ke E-mail Anda.</li>
								</ul>
								<form id="form-convert" method="post">
									...
									<button type="submit" class="btn btn-info btn-fill" name="aksi" value="gantiemail">Ganti E-mail</button>
									<div class="clearfix"></div>
								</form>
							</div>
							<?php } ?>
...
<!-------------------------------------------------------------------------------- Start Dashboard ------------------------------------------------------------------------------------------>						
							...
							<div class="content">
								...
								<ul>
									<li>Awal Pendaftaran Mendapat Koin 1000 Silver(10 Gold) Didapat Setelah Melakukan Verifikasi Email.</li>
