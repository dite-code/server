...
//				fw.close();
		...
		if(request.getParameter("process").compareTo("startserver") == 0)
		{
			...
			try
			{
				...
				fw.write("if [ ! -d " + pw_server_path + "logservice/logs ]; then\n");
				fw.write("mkdir " + pw_server_path + "logservice/logs\n");
				fw.write("fi\n");
				fw.write("cd " + pw_server_path + "logservice; ./logservice logservice.conf >" + pw_server_path + "logservice/logs/logservice.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "uniquenamed; ./uniquenamed gamesys.conf >" + pw_server_path + "logservice/logs/uniquenamed.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "authd; ./authd start &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gamedbd; ./gamedbd gamesys.conf >" + pw_server_path + "logservice/logs/gamedbd.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gacd; ./gacd gamesys.conf >" + pw_server_path + "logservice/logs/gacd.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gfactiond; ./gfactiond gamesys.conf >" + pw_server_path + "logservice/logs/gfactiond.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gdeliveryd; ./gdeliveryd gamesys.conf >" + pw_server_path + "logservice/logs/gdeliveryd.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "glinkd; ./glinkd gamesys.conf 1 >" + pw_server_path + "logservice/logs/glink1.log &\n");
				fw.write("cd " + pw_server_path + "glinkd; ./glinkd gamesys.conf 2 >" + pw_server_path + "logservice/logs/glink2.log &\n");
				fw.write("cd " + pw_server_path + "glinkd; ./glinkd gamesys.conf 3 >" + pw_server_path + "logservice/logs/glink3.log &\n");
				fw.write("cd " + pw_server_path + "glinkd; ./glinkd gamesys.conf 4 >" + pw_server_path + "logservice/logs/glink4.log &\n");
				//fw.write("cd " + pw_server_path + "glinkd; ./glinkd gamesys.conf 5 >" + pw_server_path + "logservice/logs/glink5.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gamed; ./gs gs01 >" + pw_server_path + "logservice/logs/gs01.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gamed; ./gs is61 >" + pw_server_path + "logservice/logs/is62.log &\n");
				fw.write("sleep 3\n");
			//	fw.write("cd " + pw_server_path + "gamed; ./gs gs01 is01 is02 is05 is06 is07 is08 is09 is10 is11 is12 is13 is14 is15 is16 is17 is18 is19 is20 is21 is22 is23 is24 is25 is26 is27is28 is29 is31 is32 is33 is34 is35 is37 is38 is39 is40 is41 is43 is44 is48 is50 bg01 bg02 bg03 bg04 bg05 bg06 arena01 arena02 arena03 arena04 >" + pw_server_path + "logservice/logs/mapscoll.log &\n");				
				fw.write("sleep 3\n");
				fw.write("rm foo\n");
				fw.write("sleep 3");
				fw.close();

				command = pw_server_path + "iweb_starter.sh";
		...
		if(request.getParameter("process").compareTo("startmap") == 0)
		{
			...
			try
			{
				...
				for(int i=0; i<maps.length; i++)
				{
					fw.write("cd " + pw_server_path + "gamed; ./gs " + maps[i] + " >" + pw_server_path + "logservice/logs/" + maps[i] + ".log &\n");
					fw.write("sleep 1\n");
				}
				fw.write("rm foo\n");
				fw.write("sleep 1");
